		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#zbtpday6exercise3zaragoza-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday6exercise3zaragoza-display": {
								"semanticObject": "zbtpday6exercise3zaragoza",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day6exercise3zaragoza",
									"url": sap.ui.require.toUrl("zbtp/day6exercise3zaragoza")
								}
							}
						}
					}
